...
const jsonLd = {
        ...
        url: `https://bokepimut.pages.dev/v/${file.filecode}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `WatchAction`,
                target: `https://bokepimut.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd2 = {
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepimut.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokepimut.pages.dev'
              },
        interactionStatistic: {
            '@type': `InteractionCounter`,
                userInteractionCount: `${file.views}`,
